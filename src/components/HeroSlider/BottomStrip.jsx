        ...
        <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 flex items-center justify-between py-3 sm:py-4 gap-3">
          ...
          <div className="flex items-center gap-2 shrink-0">
            <button
              ...
              className="flex h-10 w-10 sm:h-11 sm:w-11 items-center justify-center rounded-xl border border-slate-200 bg-white text-slate-500 shadow-sm transition-all duration-200 hover:border-primary hover:text-primary hover:-translate-y-0.5 active:translate-y-0"
            >
              <ArrowLeft size={16} />
            </button>
            <button
